...
class Program
{
    static void Main(string[] args)
    {
        ...
        while (ASMenuChoice != 4)
        {
            ...
            if (ASMenuChoice == 1)
            {
                ...
                OSActivity.ASRunActivity();

            }
            else if (ASMenuChoice == 2)
            {
    ...
    static int OSMenu()
    {
        ...
        int ASMenuChoice = int.Parse(Console.ReadLine());
        return ASMenuChoice;
    }
}